...
export const updateRecommendationController = async(req, res) => {
  ...
  try {
    ...
    if (recommendation) {
      ...
      if (medicalHistory || healthGoals) {
        ...
        const updatedRecommendation = await promptGPT(recommendation.medicalHistory, recommendation.healthGoals, age, user.gender)
